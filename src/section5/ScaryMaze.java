...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Bad Maze 2.jpg"));
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("208021__cocoricosound__cock-a-doodle-doo.wav"));
sound.play();
		...
		showScaryImage("RandomFloatingPuffballCats-1.gif");
	}
